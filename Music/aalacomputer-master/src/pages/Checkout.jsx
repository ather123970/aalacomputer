...
const Checkout = () => {
  ...
  if (!pending || !pending.items || pending.items.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex flex-col items-center justify-center text-center px-4">
        <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-10 max-w-lg shadow-2xl">
          <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-6">
            <ShoppingCart className="w-12 h-12 text-blue-400" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-3 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">No Pending Order</h2>
          <p className="text-gray-400 mb-8 text-lg leading-relaxed">
            Your cart is empty! Add items to your cart and click{' '}
            <span className="font-semibold text-blue-400">"Place Full Order"</span> to proceed to checkout.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={() => navigate('/cart')}
              className="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-xl font-semibold transition-all shadow-lg"
            >
              View Cart
            </button>
            <button
              onClick={() => navigate('/products')}
              className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white rounded-xl font-semibold transition-all shadow-lg transform hover:scale-105"
            >
              Browse Products
            </button>
          </div>
