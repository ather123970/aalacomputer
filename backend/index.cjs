...
if (fs.existsSync(distDir)) {
  ...
  app.get('*', (req, res) => {
    // If file exists serve it, else send index.html for SPA
  ...
  console.log('[server] dist/ not found; frontend static not served. Build frontend and push dist/ if you want the SPA served by backend.');
}
